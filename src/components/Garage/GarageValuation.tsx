...
export const TrendView = ({ isNeg, percentageChange }: GeneratedValues) => {
  return (
    <div className={cn("rounded-4xl flex flex-row items-center gap-2 px-4 py-2 -flex-1 w-fit h-fit font-extrabold opacity-0 animate-fadein", isNeg ? "bg-red-400" : "bg-green-500")} >
      <div>
        {
          isNeg
...
export function GarageValuation({ cars }: { cars: Car[] }) {
  ...
  return (
    <div className="py-12">
      <p className="text-xs tracking-widest uppercase text-gold">Fleet Valuation</p>
