import { CarIcon, GarageIcon, GavelIcon, MoonIcon, SunIcon, } from "@phosphor-icons/react";
              ...
              return (
                <Button
                  ...
                  >
                    {({ isActive }) => (
                      <>
                        <Icon weight={`${isActive ? "fill" : "regular"}`} className="!w-6 !h-6 shrink-0" />
                        <span className={cn("hidden sm:inline", isActive && "font-bold")}>
                          {link.name}
                        </span>
                      </>
                    )}
